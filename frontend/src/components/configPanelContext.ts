 ...
 *  (rendered deep inside the message tree by ToolCall) needs to pop itself
 *  into the right side panel. Carried via context so the callback doesn't
 *  have to be threaded through every message-rendering helper.
 *
