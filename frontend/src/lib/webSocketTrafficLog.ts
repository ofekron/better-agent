...
export const KNOWN_WEB_SOCKET_EVENT_TYPES = new Set([
  ...
  "snapshot_refresh_complete", "snapshot_cancelled",
  ...
  "project_aggregates_changed", "project_updates_changed", "project_mappings_changed",
  "session_status_changed", "turn_started", "turn_stopped",
  ...
  "provider_install_finished", "extension.catalog", "extension.config",
  ...
  "extension_updates_changed", "models_catalog_changed",
  "installation_capabilities_changed", "prompt_queued",
  ...
  "startup_task_changed", "background_work_changed", "command_received",
  ...
  "snapshot_refresh", "ping", "pong", "extension_toast",
]);
