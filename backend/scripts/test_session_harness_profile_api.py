...
def main_test() -> None:
    ...
    assert harness_profile_resolver.resolve_for_session(assigned_session)["profile_id"] == capture_profile["id"]
    ...
    assert harness_profile_resolver.resolve_for_session(default_session)["profile_id"] == "default"


if __name__ == "__main__":
    main_test()
    print("PASS session harness profile API")
