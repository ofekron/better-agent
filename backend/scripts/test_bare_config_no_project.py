...
def main() -> int:
    ...
    work = tempfile.mkdtemp(prefix="bc-test-bareproj-work-")
    try:
        ...
        bare_dir = os.path.join(work, "ext-install-dir")
        ...
        normal_dir = os.path.join(work, "real-project")
