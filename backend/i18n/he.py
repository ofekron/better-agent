TRANSLATIONS: dict[str, str] = {
    ...
    "error.browser_panel_url_required": "נדרש `url` ללוח דפדפן",
    "error.browser_panel_url_invalid": "`url` ללוח דפדפן חייב להתחיל ב-http:// או https://",
    "error.browser_panels_list_required": "`panels` חייב להיות רשימה",
