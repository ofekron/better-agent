TRANSLATIONS: dict[str, str] = {
    ...
    "error.browser_panel_url_required": "browser panel `url` is required",
    "error.browser_panel_url_invalid": "browser panel `url` must be http:// or https://",
    "error.browser_panels_list_required": "`panels` must be a list",
