...
LINE_NAME="dev"
DEFAULT_BA_HOME="$HOME/.better-claude"
LINE_DEFAULT_BACKEND_PORT=18765
LINE_DEFAULT_FRONTEND_PORT=5173
case "$(basename "$DIR")" in
  *-main)
    LINE_NAME="main"
    DEFAULT_BA_HOME="$HOME/.better-claude-main"
    LINE_DEFAULT_BACKEND_PORT=18766
    LINE_DEFAULT_FRONTEND_PORT=5174
    ;;
  *-qa)
    LINE_NAME="qa"
    DEFAULT_BA_HOME="$HOME/.better-claude-qa"
    LINE_DEFAULT_BACKEND_PORT=18767
    LINE_DEFAULT_FRONTEND_PORT=5175
    ;;
esac
export BETTER_AGENT_LINE_NAME="${BETTER_AGENT_LINE_NAME:-$LINE_NAME}"
export BETTER_AGENT_PARALLEL_LINES="${BETTER_AGENT_PARALLEL_LINES:-1}"
BA_HOME="${BETTER_AGENT_HOME:-${BETTER_CLAUDE_HOME:-$DEFAULT_BA_HOME}}"
...
BACKEND_PORT="${BETTER_AGENT_BACKEND_PORT:-${BETTER_CLAUDE_BACKEND_PORT:-$LINE_DEFAULT_BACKEND_PORT}}"
FRONTEND_PORT="${BETTER_AGENT_FRONTEND_PORT:-${BETTER_CLAUDE_FRONTEND_PORT:-$LINE_DEFAULT_FRONTEND_PORT}}"
